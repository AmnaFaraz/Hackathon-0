  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Glow blobs */}
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00D4FF]/5 rounded-full blur-3xl animate-pulse"
          aria-hidden="true"
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#7C3AED]/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#00D4FF]/30 bg-[#00D4FF]/5 text-[#00D4FF] text-xs font-mono mb-8">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce" aria-hidden="true">
        <ChevronDown className="w-5 h-5 text-[#484F58]" />
      </div>
    </section>
  );
}
